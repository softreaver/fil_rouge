...
export class PostgresTransaction implements Persistor {
    ...
    insert(repository: Repository, entities: import("./Entity").Entity | import("./Entity").Entity[]): number {
        throw new Error("Method not implemented.");
    }
    delete(repository: Repository, entityToRemove: import("./Entity").Entity): number {
        throw new Error("Method not implemented.");
    }
    update(repository: Repository, entityToUpdate: import("./Entity").Entity): number {
        throw new Error("Method not implemented.");
    }
    findAll(repository: Repository): import("./Entity").Entity[] {
        throw new Error("Method not implemented.");
    }
    deleteWhere(repository: Repository, conditions: any): number {
        throw new Error("Method not implemented.");
    }
    findWhere(repository: Repository, conditions: any): import("./Entity").Entity[] {
        throw new Error("Method not implemented.");
    }
    findOne(repository: Repository, PKValue: any): import("./Entity").Entity {
        throw new Error("Method not implemented.");
    }
